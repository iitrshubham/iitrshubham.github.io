...
const X_ = () => {
   ...
   ro = [{
      ...
      tools: ["Python (Pandas): For data manipulation and cleaning", "Jupyter Notebook: For code development and documentation", "Looker Studio: For dashboard creation and visualization", "Git & GitHub: For version control and project collaboration"],
      ...
      methodology: ` • Explored and understood the dataset to identify key features and patterns.
                      ...
                      • Trained a Random Forest Classifier to classify fraudulent and non-fraudulent transactions.
                      • Evaluated the model using classification metrics to measure performance.`,
      resultsAndImpact: ` • Achieved 100% accuracy, precision, recall, and F1-score on the test dataset.
                          • Identified only 6 false positives and 14 false negatives out of 113,726 transactions.
               ...
               children: f.jsxs(Te.div, {
                  ...
                  children: [f.jsxs("button", {
                     ...
                     children: f.jsxs("div", {
                        ...
                        }), e.imageUrl && !["Power BI", "Looker Studio", "Tableau"].includes(e.category) && f.jsx("div", {
                           className: "mb-10",
                           children: f.jsx("div", {
                        ...
                        }), e.category === "Looker Studio" && f.jsxs("div", {
                           className: "mt-8",
                           children: [f.jsx("h2", {
                              className: "text-2xl font-bold mb-4",
                              children: "Interactive Dashboard"
   ...
   q4 = ({
      ...
      b.useEffect(() => {
         ...
         const p = t.category.split("-").map(y => y.charAt(0).toUpperCase() + y.slice(1).toLowerCase()).join(" "),
            m = ro.filter(y => y.category.toLowerCase() === p.toLowerCase() || p === "Machine Learning" && y.category === "Machine Learning" || p === "Looker Studio" && y.category === "Looker Studio" || t.category === "looker-studio" && y.category === "Looker Studio");
         r(m)
      }, [t.category]);
