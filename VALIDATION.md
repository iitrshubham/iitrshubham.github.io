...
Checked on 7 September 2026 against the user-designated GitHub source at commit `291ddbaf8a35d09642abcc07d443381590366517` and the requested search, news, table-of-contents, and membership-emblem updates. Unrelated repository content and workflows were preserved.
...
The existing publication-discovery workflow is preserved, including its pre-existing dependency on a missing script. It is independent of website building and deployment.
